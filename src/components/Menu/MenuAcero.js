...
export default function SimpleMenuAcero() {
  ...
  return (
    ...
    <div>
      ...
      <StyledMenu id="demo-customized-menu" MenuListProps={{'aria-labelledby': 'demo-customized-button', }} anchorEl={anchorEl} open={open} onClose={handleClose} >
        ...
        <MenuItem onClick={handleClose} disableRipple>  PTR </MenuItem>
        <Divider sx={{ my: 0.5 }} /> 
        <MenuItem onClick={handleClose} disableRipple>  Varilla </MenuItem>

        <MenuItem onClick={handleClose} disableRipple>  Alambres </MenuItem>
      </StyledMenu>
    </div>

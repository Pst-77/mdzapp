      ...
      <div className='container-nm-precio'>
        <TableContainer component={Paper}>
          <Table sx={{ minWidth: 'auto' }} size="small" aria-label="a dense table">
            ...
            <TableRow >
              <TableCell align="center" sx={{ background: '#D5DBDB', color: '#002652' }}>Nombre</TableCell>
              <TableCell align="center" sx={{ background: '#D5DBDB', color: '#002652' }}>Precio</TableCell>
              <TableCell align="center" sx={{ background: '#D5DBDB', color: '#002652' }}>Cantidad</TableCell>
              <TableCell align="center" sx={{ background: '#D5DBDB', color: '#002652' }}>Total</TableCell>
            </TableRow>
          </Table>
        </TableContainer>
